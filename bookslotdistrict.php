...
$sql = "UPDATE `vaccinecenters` SET `slots_available`='$slotsavailable' WHERE 
        `center_district_name`='$district' and `center_name`='$centername' ";
// echo $sql;
...
$result = mysqli_query($conn, $sql);
// echo "<script>window.open('send_email.php','_self')</script>";
