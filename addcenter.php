...
.a{
  ...
  <div class="a">
<form action="addcentercontroller.php" method="post">
		vaccine center name:- <input type="text" name="centerName"> <br>
		vaccine center address:- <input type="text" name="centerAddress"><br>
		vaccine center pin:- <input type="number" name="centerPin"><br>
		vaccine center district:- <input type="text" name="centerDistrict"><br>
		vaccine slots:- <input type="number" name="vaccineSlots"><br>
		<input type="submit" name="Add Center">
	</form>
</div>
  <!-- Start footer -->
  <footer id="mu-footer">
