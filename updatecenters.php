          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <?php
              if(!(isset($_SESSION['username']))) {
                ...
                echo "<li><a href='adminregisterindex.php'>Hi!, ".$_SESSION['username']."</a></li>";
  ...
  echo "<div>";
     ...
     while($row = $result->fetch_assoc()) {
            ...
            echo "<tr>";
              ...
              echo "</td>";
              echo "<td>";
                echo "<form action='updatecenterscontroller.php'>";
            echo "<input type='hidden' name='ID' value=".$row['ID'].">";
          echo "<input type='number' name='slotsavailable' value=".$row["slots_available"].">";
          echo "</td>";
          echo "<td>";
