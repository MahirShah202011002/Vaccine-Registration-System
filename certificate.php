...
#customers th {
       ...
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <ol class="breadcrumb">
            ...
            <!-- <li><a href="searchdistrict.php">Search By District</a></li> -->
  ...
  <!-- <div style="margin-top: 150px; height: 300px;	" align="center"> -->
    <div>
		<?php
		$name = $_SESSION['username'];
			$conn = mysqli_connect("localhost", "root", "", "vaccineregistration");
		$sql = " SELECT account_name, name, COUNT(ID) as total FROM bookedSlots 
		WHERE account_name='$name' GROUP BY account_name, name";
		$result = mysqli_query($conn, $sql);
		echo "<table id='customers'>";
		echo "<tr>";
			echo "<th>Name</th>";
			echo "<th>Dose1 Certificate</th>";
			echo "<th>Dose2 Certificate</th>";
		echo "</tr>";
		...
		while($row = mysqli_fetch_array($result)) {  
			...
			if($row['total'] == 1) {
				echo "<tr>";
					...
					echo "</td>";
					echo "<td>";
						echo "<a href=\"downloadCertificate.php?name=$name\">Cerificate for Dose 1";
					echo "</td>";
					echo "<td>";
						echo "Not Available";
					echo "</td>";
				...
				echo "<tr>";
					...
					echo "</td>";
					echo "<td>";
						echo "<a href=\"downloadCertificate2.php?name=$name\">Cerificate for Dose 2";
					echo "</td>";
				echo "</tr>";		
			}
		}
