...
<html lang="en">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="mu-service-area">
            ...
            <div class="mu-service-single">
             ...
             <a href="searchpin.php"><h3>Search By Pin</h3></a>

              <p>Search Vaccine Center by pin</p>
            </div>
            <!-- Start single service -->
            <!-- Start single service -->
            <div class="mu-service-single">
              <span class="fa fa-users"></span>
            <a href="members.php" > <h3>Members</h3></a>
              <p>Display list of all members</p>
            </div>
            <!-- Start single service -->
            <!-- Start single service -->
            <div class="mu-service-single">
              <span class="fa fa-table"></span>
              <a href="searchdistrict.php"><h3>Search By District</h3></a>
              <!-- <h3>Search By District</h3> -->
              <p>Search Vaccine Center by district</p>
            </div>
            <!-- Start single service -->
          </div>
        </div>
 ...
 <br>
  ...
  <!-- Start footer -->
  <footer id="mu-footer" style="margin-top: 50px;">
    <!-- start footer top -->
