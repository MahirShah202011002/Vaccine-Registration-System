...
<section id="mu-page-breadcrumb" style="margin-top: 3px;">
       ...
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <ol class="breadcrumb">
            ...
            <li class="active">Search By District</li>
          </ol>
         </div>
       </div>
     </div>
 ...
 <br>
  ...
  echo "<form action=\"searchdistrictcontroller.php\">";
  
echo "<label for=\"district\">Enter District Name</label>";
echo "<input type=\"text\" id=\"district\" name=\"district\">";
echo "<br>";
