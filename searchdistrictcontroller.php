...
#customers th {
 ...
 <br>
<!-- <div align='center' style="margin-top: 200px;  height:300px;"> -->
  <div>
<?php
...
$query = " SELECT * FROM `vaccinecenters` WHERE center_district_name='$district' ";
	...
	#echo print_r($rows);
     ...
     while($row = $result->fetch_assoc()) {
        ...
        echo "<td>";
          ...
          echo "<form action='bookslotdistrict.php'>";
            echo "<input type='hidden' name='districtname' value=".$row["center_district_name"].">";
            ...
            echo "<input type='hidden' name='centerpin' value=".$row["center_pin"].">";
