       ...
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <ol class="breadcrumb">
            ...
            <li class="active">Search By Pin</li>
          </ol>
         </div>
       </div>
     </div>
...
<?php
	if(isset($_SESSION['name'])) {
		echo "<form action=\"searchpincontroller.php\">";
		echo "<label for=\"pin\">Enter PIN Number</label>";
		echo "<input type=\"number\" id=\"pin\" name=\"pin\" >"."<br>";
		// echo "<button>Submit</button>";
    echo "<input type=\"submit\" name=\"Search\">";
	   echo "</form>";
	   echo "</div>";
	}

else {
	echo "<a href=\"members.php\">Members Not Set! Please selecte member first</a>";
}
?>
</div>
  <br>
